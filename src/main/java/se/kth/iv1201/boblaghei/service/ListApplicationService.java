...
public class ListApplicationService {
    ...
    public List<Application> findApplications(ApplicationSearchDTO dto) {
        ...
        return (List<Application>) criteria.setResultTransformer(CriteriaSpecification.DISTINCT_ROOT_ENTITY).list();
    }
